...
function cover_R_extrude_28_3_outline_fn(){
    return new CSG.Path2D([[261,-66.41],[280,-66.41]]).appendPoint([280,-105.41]).appendArc([279.9827449,-105.8250339],{"radius":5,"clockwise":true,"large":false}).appendArc([280,-106.01],{"radius":1,"clockwise":true,"large":false}).appendPoint([280,-109.41]).appendArc([279,-110.41],{"radius":1,"clockwise":true,"large":false}).appendPoint([256,-110.41]).appendPoint([256,-71.41]).appendArc([261,-66.41],{"radius":5,"clockwise":true,"large":false}).close().innerToCAG()
.extrude({ offset: [0, 0, 28.3] });
}


function cover_R_extrude_24_3_outline_fn(){
    return new CSG.Path2D([[261,-66.41],[280,-66.41]]).appendPoint([280,-105.41]).appendArc([279.9827449,-105.8250339],{"radius":5,"clockwise":true,"large":false}).appendArc([280,-106.01],{"radius":1,"clockwise":true,"large":false}).appendPoint([280,-109.41]).appendArc([279,-110.41],{"radius":1,"clockwise":true,"large":false}).appendPoint([256,-110.41]).appendPoint([256,-71.41]).appendArc([261,-66.41],{"radius":5,"clockwise":true,"large":false}).close().innerToCAG()
.extrude({ offset: [0, 0, 24.3] });
}
...
.union(
    ...
    CAG.circle({"center":[394,-80.5],"radius":1.25})
                ...
                function _cover_cap_R_case_fn() {
                    

                // creating part 0 of case _cover_cap_R
                let _cover_cap_R__part_0 = cover_R_extrude_28_3_outline_fn();

                // make sure that rotations are relative
                let _cover_cap_R__part_0_bounds = _cover_cap_R__part_0.getBounds();
                let _cover_cap_R__part_0_x = _cover_cap_R__part_0_bounds[0].x + (_cover_cap_R__part_0_bounds[1].x - _cover_cap_R__part_0_bounds[0].x) / 2
                let _cover_cap_R__part_0_y = _cover_cap_R__part_0_bounds[0].y + (_cover_cap_R__part_0_bounds[1].y - _cover_cap_R__part_0_bounds[0].y) / 2
                _cover_cap_R__part_0 = translate([-_cover_cap_R__part_0_x, -_cover_cap_R__part_0_y, 0], _cover_cap_R__part_0);
                _cover_cap_R__part_0 = rotate([0,0,0], _cover_cap_R__part_0);
                _cover_cap_R__part_0 = translate([_cover_cap_R__part_0_x, _cover_cap_R__part_0_y, 0], _cover_cap_R__part_0);

                _cover_cap_R__part_0 = translate([0,0,0], _cover_cap_R__part_0);
                let result = _cover_cap_R__part_0;
                
            

                // creating part 1 of case _cover_cap_R
                let _cover_cap_R__part_1 = cover_R_extrude_24_3_outline_fn();

                // make sure that rotations are relative
                let _cover_cap_R__part_1_bounds = _cover_cap_R__part_1.getBounds();
                let _cover_cap_R__part_1_x = _cover_cap_R__part_1_bounds[0].x + (_cover_cap_R__part_1_bounds[1].x - _cover_cap_R__part_1_bounds[0].x) / 2
                let _cover_cap_R__part_1_y = _cover_cap_R__part_1_bounds[0].y + (_cover_cap_R__part_1_bounds[1].y - _cover_cap_R__part_1_bounds[0].y) / 2
                _cover_cap_R__part_1 = translate([-_cover_cap_R__part_1_x, -_cover_cap_R__part_1_y, 0], _cover_cap_R__part_1);
                _cover_cap_R__part_1 = rotate([0,0,0], _cover_cap_R__part_1);
                _cover_cap_R__part_1 = translate([_cover_cap_R__part_1_x, _cover_cap_R__part_1_y, 0], _cover_cap_R__part_1);

                _cover_cap_R__part_1 = translate([0,0,0], _cover_cap_R__part_1);
                result = result.subtract(_cover_cap_R__part_1);
                ...
                function wall_cover_case_R_case_fn() {
                    

                // creating part 0 of case wall_cover_case_R
                let wall_cover_case_R__part_0 = _outerWall_R_case_fn();

                // make sure that rotations are relative
                let wall_cover_case_R__part_0_bounds = wall_cover_case_R__part_0.getBounds();
                let wall_cover_case_R__part_0_x = wall_cover_case_R__part_0_bounds[0].x + (wall_cover_case_R__part_0_bounds[1].x - wall_cover_case_R__part_0_bounds[0].x) / 2
                let wall_cover_case_R__part_0_y = wall_cover_case_R__part_0_bounds[0].y + (wall_cover_case_R__part_0_bounds[1].y - wall_cover_case_R__part_0_bounds[0].y) / 2
                wall_cover_case_R__part_0 = translate([-wall_cover_case_R__part_0_x, -wall_cover_case_R__part_0_y, 0], wall_cover_case_R__part_0);
                wall_cover_case_R__part_0 = rotate([0,0,0], wall_cover_case_R__part_0);
                wall_cover_case_R__part_0 = translate([wall_cover_case_R__part_0_x, wall_cover_case_R__part_0_y, 0], wall_cover_case_R__part_0);

                wall_cover_case_R__part_0 = translate([0,0,0], wall_cover_case_R__part_0);
                let result = wall_cover_case_R__part_0;
                
            

                // creating part 1 of case wall_cover_case_R
                let wall_cover_case_R__part_1 = _innerWall_R_case_fn();

                // make sure that rotations are relative
                let wall_cover_case_R__part_1_bounds = wall_cover_case_R__part_1.getBounds();
                let wall_cover_case_R__part_1_x = wall_cover_case_R__part_1_bounds[0].x + (wall_cover_case_R__part_1_bounds[1].x - wall_cover_case_R__part_1_bounds[0].x) / 2
                let wall_cover_case_R__part_1_y = wall_cover_case_R__part_1_bounds[0].y + (wall_cover_case_R__part_1_bounds[1].y - wall_cover_case_R__part_1_bounds[0].y) / 2
                wall_cover_case_R__part_1 = translate([-wall_cover_case_R__part_1_x, -wall_cover_case_R__part_1_y, 0], wall_cover_case_R__part_1);
                wall_cover_case_R__part_1 = rotate([0,0,0], wall_cover_case_R__part_1);
                wall_cover_case_R__part_1 = translate([wall_cover_case_R__part_1_x, wall_cover_case_R__part_1_y, 0], wall_cover_case_R__part_1);

                wall_cover_case_R__part_1 = translate([0,0,0], wall_cover_case_R__part_1);
                result = result.subtract(wall_cover_case_R__part_1);
                
            

                // creating part 2 of case wall_cover_case_R
                let wall_cover_case_R__part_2 = _usb_access_cut_R_case_fn();

                // make sure that rotations are relative
                let wall_cover_case_R__part_2_bounds = wall_cover_case_R__part_2.getBounds();
                let wall_cover_case_R__part_2_x = wall_cover_case_R__part_2_bounds[0].x + (wall_cover_case_R__part_2_bounds[1].x - wall_cover_case_R__part_2_bounds[0].x) / 2
                let wall_cover_case_R__part_2_y = wall_cover_case_R__part_2_bounds[0].y + (wall_cover_case_R__part_2_bounds[1].y - wall_cover_case_R__part_2_bounds[0].y) / 2
                wall_cover_case_R__part_2 = translate([-wall_cover_case_R__part_2_x, -wall_cover_case_R__part_2_y, 0], wall_cover_case_R__part_2);
                wall_cover_case_R__part_2 = rotate([0,0,0], wall_cover_case_R__part_2);
                wall_cover_case_R__part_2 = translate([wall_cover_case_R__part_2_x, wall_cover_case_R__part_2_y, 0], wall_cover_case_R__part_2);

                wall_cover_case_R__part_2 = translate([0,0,0], wall_cover_case_R__part_2);
                result = result.subtract(wall_cover_case_R__part_2);
                
            

                // creating part 3 of case wall_cover_case_R
                let wall_cover_case_R__part_3 = _usb_access_fill_R_case_fn();

                // make sure that rotations are relative
                let wall_cover_case_R__part_3_bounds = wall_cover_case_R__part_3.getBounds();
                let wall_cover_case_R__part_3_x = wall_cover_case_R__part_3_bounds[0].x + (wall_cover_case_R__part_3_bounds[1].x - wall_cover_case_R__part_3_bounds[0].x) / 2
                let wall_cover_case_R__part_3_y = wall_cover_case_R__part_3_bounds[0].y + (wall_cover_case_R__part_3_bounds[1].y - wall_cover_case_R__part_3_bounds[0].y) / 2
                wall_cover_case_R__part_3 = translate([-wall_cover_case_R__part_3_x, -wall_cover_case_R__part_3_y, 0], wall_cover_case_R__part_3);
                wall_cover_case_R__part_3 = rotate([0,0,0], wall_cover_case_R__part_3);
                wall_cover_case_R__part_3 = translate([wall_cover_case_R__part_3_x, wall_cover_case_R__part_3_y, 0], wall_cover_case_R__part_3);

                wall_cover_case_R__part_3 = translate([0,0,0], wall_cover_case_R__part_3);
                result = result.union(wall_cover_case_R__part_3);
                
            

                // creating part 4 of case wall_cover_case_R
                let wall_cover_case_R__part_4 = _button_access_cut_R_case_fn();

                // make sure that rotations are relative
                let wall_cover_case_R__part_4_bounds = wall_cover_case_R__part_4.getBounds();
                let wall_cover_case_R__part_4_x = wall_cover_case_R__part_4_bounds[0].x + (wall_cover_case_R__part_4_bounds[1].x - wall_cover_case_R__part_4_bounds[0].x) / 2
                let wall_cover_case_R__part_4_y = wall_cover_case_R__part_4_bounds[0].y + (wall_cover_case_R__part_4_bounds[1].y - wall_cover_case_R__part_4_bounds[0].y) / 2
                wall_cover_case_R__part_4 = translate([-wall_cover_case_R__part_4_x, -wall_cover_case_R__part_4_y, 0], wall_cover_case_R__part_4);
                wall_cover_case_R__part_4 = rotate([0,0,0], wall_cover_case_R__part_4);
                wall_cover_case_R__part_4 = translate([wall_cover_case_R__part_4_x, wall_cover_case_R__part_4_y, 0], wall_cover_case_R__part_4);

                wall_cover_case_R__part_4 = translate([0,0,0], wall_cover_case_R__part_4);
                result = result.subtract(wall_cover_case_R__part_4);
                
            

                // creating part 5 of case wall_cover_case_R
                let wall_cover_case_R__part_5 = _button_access_fill_R_case_fn();

                // make sure that rotations are relative
                let wall_cover_case_R__part_5_bounds = wall_cover_case_R__part_5.getBounds();
                let wall_cover_case_R__part_5_x = wall_cover_case_R__part_5_bounds[0].x + (wall_cover_case_R__part_5_bounds[1].x - wall_cover_case_R__part_5_bounds[0].x) / 2
                let wall_cover_case_R__part_5_y = wall_cover_case_R__part_5_bounds[0].y + (wall_cover_case_R__part_5_bounds[1].y - wall_cover_case_R__part_5_bounds[0].y) / 2
                wall_cover_case_R__part_5 = translate([-wall_cover_case_R__part_5_x, -wall_cover_case_R__part_5_y, 0], wall_cover_case_R__part_5);
                wall_cover_case_R__part_5 = rotate([0,0,0], wall_cover_case_R__part_5);
                wall_cover_case_R__part_5 = translate([wall_cover_case_R__part_5_x, wall_cover_case_R__part_5_y, 0], wall_cover_case_R__part_5);

                wall_cover_case_R__part_5 = translate([0,0,0], wall_cover_case_R__part_5);
                result = result.union(wall_cover_case_R__part_5);
                
            

                // creating part 6 of case wall_cover_case_R
                let wall_cover_case_R__part_6 = _cover_cap_R_case_fn();

                // make sure that rotations are relative
                let wall_cover_case_R__part_6_bounds = wall_cover_case_R__part_6.getBounds();
                let wall_cover_case_R__part_6_x = wall_cover_case_R__part_6_bounds[0].x + (wall_cover_case_R__part_6_bounds[1].x - wall_cover_case_R__part_6_bounds[0].x) / 2
                let wall_cover_case_R__part_6_y = wall_cover_case_R__part_6_bounds[0].y + (wall_cover_case_R__part_6_bounds[1].y - wall_cover_case_R__part_6_bounds[0].y) / 2
                wall_cover_case_R__part_6 = translate([-wall_cover_case_R__part_6_x, -wall_cover_case_R__part_6_y, 0], wall_cover_case_R__part_6);
                wall_cover_case_R__part_6 = rotate([0,0,0], wall_cover_case_R__part_6);
                wall_cover_case_R__part_6 = translate([wall_cover_case_R__part_6_x, wall_cover_case_R__part_6_y, 0], wall_cover_case_R__part_6);

                wall_cover_case_R__part_6 = translate([0,0,0], wall_cover_case_R__part_6);
                result = result.union(wall_cover_case_R__part_6);
                
            

                // creating part 7 of case wall_cover_case_R
                let wall_cover_case_R__part_7 = _wall_insert_R_case_fn();

                // make sure that rotations are relative
                let wall_cover_case_R__part_7_bounds = wall_cover_case_R__part_7.getBounds();
                let wall_cover_case_R__part_7_x = wall_cover_case_R__part_7_bounds[0].x + (wall_cover_case_R__part_7_bounds[1].x - wall_cover_case_R__part_7_bounds[0].x) / 2
                let wall_cover_case_R__part_7_y = wall_cover_case_R__part_7_bounds[0].y + (wall_cover_case_R__part_7_bounds[1].y - wall_cover_case_R__part_7_bounds[0].y) / 2
                wall_cover_case_R__part_7 = translate([-wall_cover_case_R__part_7_x, -wall_cover_case_R__part_7_y, 0], wall_cover_case_R__part_7);
                wall_cover_case_R__part_7 = rotate([0,0,0], wall_cover_case_R__part_7);
                wall_cover_case_R__part_7 = translate([wall_cover_case_R__part_7_x, wall_cover_case_R__part_7_y, 0], wall_cover_case_R__part_7);

                wall_cover_case_R__part_7 = translate([0,0,0], wall_cover_case_R__part_7);
                result = result.subtract(wall_cover_case_R__part_7);
            ...
            function main() {
                return wall_cover_case_R_case_fn();
            }
